...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("mogenart")
              
                await self.one.join_chat("MLBBShopHiro")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("mogenart")
                
                await self.one.join_chat("molemutualan")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("MLBBShopHiro")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("MLBBShopHiro")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("molemutualanz")
